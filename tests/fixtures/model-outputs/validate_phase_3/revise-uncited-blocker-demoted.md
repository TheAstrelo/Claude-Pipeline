...
|---|---|---|---|---|---|
| 1 | Security | BLOCKER | The session signing key is a literal in config/default.json, so anyone who can read the repository can mint valid sessions. | - | Load the key from an environment variable and fail startup when it is unset. |
